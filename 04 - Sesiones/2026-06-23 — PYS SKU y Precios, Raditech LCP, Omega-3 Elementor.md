...
- [ ] **PYS LCP 5.6s** — siguiente optimización: priorizar la imagen hero del home (`fetchpriority=high` / preload del LCP, verificar peso del hero). Es lo único que frena Rendimiento de 78 a verde (90+).
