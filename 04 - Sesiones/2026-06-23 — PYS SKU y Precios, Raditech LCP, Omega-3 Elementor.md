...
- [ ] **PYS rendimiento a verde (90+)** — siguiente palanca: render-blocking CSS de Elementor (varios post-*.css). Opciones: LiteSpeed "Load CSS Asynchronously" + Critical CSS (probar con cuidado, riesgo FOUC). LCP residual 4.5s aún mejorable.
